...
WORKDIR /tmp
RUN cat jdk-8u111-linux-x64.tar.001 jdk-8u111-linux-x64.tar.002 | tar -xv
...
WORKDIR /tmp
RUN cat oracle-xe-11.2.0-1.0.x86_64.tar.001 oracle-xe-11.2.0-1.0.x86_64.tar.002 oracle-xe-11.2.0-1.0.x86_64.tar.003 oracle-xe-11.2.0-1.0.x86_64.tar.004 | tar -xv
...
WORKDIR /tmp
RUN cat scala-2.11.8.tar.001 scala-2.11.8.tar.002 | tar -xv
